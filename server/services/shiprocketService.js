...
class ShiprocketService {
    ...
    async generateShiprocketToken() {
        ...
        try {
            ...
            logger.warn('Shiprocket auth failed', {
    ...
    async createShipment(orderData) {
        ...
        try {
            ...
            logger.warn('Shiprocket create shipment failed', {
                status: error.response?.status,
                message: error.response?.data?.message || error.message
            });
    ...
    async trackShipment(awb) {
        ...
        try {
            ...
            logger.warn('Shiprocket tracking failed', {
                status: error.response?.status,
                message: error.response?.data?.message || error.message
            });
    ...
    async checkServiceability(data) {
        ...
        try {
            ...
            logger.warn('Shiprocket serviceability failed', {
                status: error.response?.status,
                message: error.response?.data?.message || error.message
            });
