...
export default function ProductReviews({ productId }: ProductReviewsProps) {
    ...
    const [ratingStats, setRatingStats] = useState<{ _id: number; count: number }[]>([]);
    ...
    return (
        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 mt-8">
            <div className="flex items-center gap-2 mb-8 border-b border-gray-100 pb-4">
                ...
                <span className="bg-gray-100 text-gray-600 px-3 py-1 rounded-full text-sm font-bold ml-2">
                    {totalReviews}
                </span>
            </div>
            ...
            {!showReviewForm && (
                <div className="flex flex-col sm:flex-row justify-between items-center mb-8 gap-4">
                    <div className="text-center sm:text-left">
                        ...
                        <p className="text-gray-500 text-sm mt-1">If you've bought this product, let others know what you think.</p>
                    </div>
                ...
                <form onSubmit={handleSubmitReview} className="mb-10 bg-gray-50 p-6 rounded-2xl border border-gray-200">
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-shadow outline-none"
                        />
                    </div>
                    ...
                    <div className="mb-6">
                        ...
                        <textarea
                            ...
                            className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-shadow outline-none resize-none"
                        ></textarea>
                    </div>
                ...
                {reviews.map((review) => (
                    <div key={review._id} className="border-b border-gray-100 pb-6 last:border-0 last:pb-0">
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <div>
                                <span className="font-bold text-gray-900 block leading-tight">{review.customerId.name}</span>
                        ...
                        <div className="mt-4 flex items-center gap-2">
                            <button className="flex items-center gap-1.5 text-sm text-gray-500 hover:text-blue-600 transition-colors font-medium border border-gray-200 px-3 py-1.5 rounded-full hover:bg-blue-50">
