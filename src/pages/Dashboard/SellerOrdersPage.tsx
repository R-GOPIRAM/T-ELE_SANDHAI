...
export default function SellerOrdersPage() {
  ...
  const getStatusStyle = (status: string) => {
    ...
    const styles: Record<string, { bg: string; text: string; dot: string; icon: ComponentType<{ className?: string }> }> = {
                        ...
                        <td className="px-8 py-6">
                          <div className="flex flex-col">
                            <span className="font-black text-text-primary uppercase text-[11px] mb-1">
                              {typeof order.user === 'object' && order.user ? order.user.name : 'Local Citizen'}
                            </span>
