                    ...
                    <Card className="p-0 border-border overflow-hidden shadow-md">
                        ...
                        <div className="p-6 space-y-4">
                            {isLoading ? (
                                ...
                                <div key={store.id} className="flex items-center gap-4 bg-background p-3 rounded-2xl border border-border hover:border-seller/50 transition-all cursor-pointer">
                                    <div className="w-12 h-12 rounded-xl bg-seller/10 flex items-center justify-center text-seller">
                                        <Package className="w-6 h-6" />
                                    </div>
                                    <div className="flex-1">
                                        <h4 className="text-[10px] font-black text-text-primary uppercase">{store.sellerName || 'Local Tech Hub'}</h4>
