        ...
        <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
                ...
                >
                  {isSubmitting ? (
                    ...
                    <span className="flex items-center gap-3">
                      Initialize Marketplace Deployment <Sparkles className="w-4 h-4 group-hover:scale-125 transition-transform text-card" />
                    </span>
                  )}
                </Button>
              )}
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            <div className="bg-primary rounded-[3rem] p-8 text-white shadow-2xl shadow-primary/20 relative overflow-hidden group">
              ...
              <p className="text-xs text-white/80 font-medium leading-relaxed relative z-10">Once deployed, your product will be immediately visible to users within your geofenced neighborhood radius.</p>
            </div>
          </div>
